...
class GovtLandInfoVC: UIViewController ,CLLocationManagerDelegate, GMSMapViewDelegate {
    ...
    @IBAction func backBtn(_ sender: Any) {
        performSegue(withIdentifier: "govtLandToDashSegue", sender: self)
    }
    
    
    @IBAction func searchFilterButton(_ sender: Any) {
        if checked{
    ...
    @IBAction func mapDetailsButton(_ sender: Any) {
        performSegue(withIdentifier: "govtDetailsSegue", sender: self)
    }
